...
import { CreateBibleStudyNoteRequest, CreateBibleStudyNoteResponse } from "../../../services/bible-study-notes/create-bible-study-note/create-bible-study-note.service";
